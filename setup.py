...
setup(name='image-funcut',
      ...
      install_requires = ['numpy',
                          'scipy',
                          #'cython', # needed for imreg
                          'numba>=0.20.0',
                          'scikit-image>=0.11.0',
                          'dill>=0.2.4',
                          #'imreg>=0.1', # strange, but can't make it work with dependency_links              
                          'pathos>=0.1',
                          'h5py>=2.5.0',
                          'pandas>=0.16.0',
                          'traits>=4.4.0',
                          'traitsui>=4.4.0',
                          'swan>=0.6.7'],
      dependency_links=['https://github.com/uqfoundation/dill/archive/master.zip#egg=dill-0.2.4',
                        'https://github.com/uqfoundation/pathos/archive/master.zip#egg=pathos-0.1',
                        'https://github.com/pyimreg/imreg/archive/master.zip#egg=imreg-0.1'],
      classifiers = [
