# -*- coding: utf-8 -*-
#
# ImFun documentation build configuration file, created by
...
MOCK_MODULES = ['matplotlib', 'scipy','numpy', 'swan',
                ...
                'scipy.ndimage', 'scipy.linalg', 'sparse.linalg', 'linalg',
...
latex_documents = [
  ('index', 'ImFun.tex', u'ImFun Documentation',
   u'Alexey Brazhe', 'manual'),
]
...
man_pages = [
    ('index', 'imfun', u'ImFun Documentation',
     [u'Alexey Brazhe'], 1)
]
...
texinfo_documents = [
  ('index', 'ImFun', u'ImFun Documentation',
   u'Alexey Brazhe', 'ImFun', 'One line description of project.',
   'Miscellaneous'),
]
